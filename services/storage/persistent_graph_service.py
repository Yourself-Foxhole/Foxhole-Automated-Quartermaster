...
class PersistentGraphService:
    ...
    def create_graph(
        ...
        graph = PersistentNetworkXGraph(
            graph_type=graph_type, graph_id=graph_id, graph_name=graph_name or graph_id
        )
    ...
    def create_node(
        self, graph_id: str, node_type: str, **kwargs
    ) -> Optional[PersistentBaseNode]:
        """
    ...
    def get_service_statistics(self) -> Dict[str, Any]:
        ...
        cache_hit_rate = (
            self._operation_counts["cache_hits"]
            / max(
                1,
                self._operation_counts["cache_hits"]
                + self._operation_counts["cache_misses"],
            )
        ) * 100
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        health = {"status": "healthy", "issues": [], "timestamp": time.time()}
