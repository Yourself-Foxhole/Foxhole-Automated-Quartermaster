<!-- This is from BurkeHolland's Beast mode prompt for the offline agent part of copilot
...
tools: ['changes', 'codebase', 'editFiles', 'extensions', 'fetch', 'findTestFiles', 'githubRepo', 'new', 'problems', 'runInTerminal', 'runNotebooks', 'runTasks', 'runTests', 'search', 'searchResults', 'terminalLastCommand', 'terminalSelection', 'testFailure', 'usages', 'vscodeAPI', 'supabase', 'context7', 'copilotCodingAgent']
---
...
- Confirm Python is available: `python3 --version` returns Python 3.13+
