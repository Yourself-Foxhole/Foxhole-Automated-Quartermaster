...
from services.storage.nodes import (
    PersistentBaseNode, PersistentInventoryNode, 
    PersistentProductionNode, PersistentTaskNode
)
...
class TestGraphStorage(unittest.TestCase):
    ...
    def test_register_graph(self):
        ...
        self.storage.register_graph('test_graph', 'production', mock_graph, {'test': 'metadata'})
...
class TestGraphMigrationManager(unittest.TestCase):
    ...
    def test_migration_session_management(self):
        ...
        self.assertEqual(len(self.migration_manager.migration_log), 2)  # start + test message
...
class TestIntegration(unittest.TestCase):
    ...
    def test_complete_workflow(self):
        ...
        graph.add_edge(salvage_node.node_id, refinery_node.node_id, 
                      material="Salvage", quantity=20)
